...
VerificationTest[
	...
	,
	{Association["Name" -> "nn", "ArgNumber" -> 0, "Definition" -> "\\nonumber"], Association["Name" -> "set", "ArgNumber" -> 1, "Definition" -> "\\{ #1 \\}"], Association["Name" -> "textInMath", "ArgNumber" -> 1, "Definition" -> "\n    \\,\n    \\text{ #1 }\n    \\,\n"], Association["Name" -> "mathred", "ArgNumber" -> 1, "Definition" -> "{\\color{red} #1}"], Association["Name" -> "eq", "ArgNumber" -> 0, "Definition" -> "="], Association["Name" -> "eqq", "ArgNumber" -> 0, "Definition" -> "\\equiv"]}
	,
	TestID->"4-regex.nb"
]
